...
class TextInputVisualizer:
    ...
    def __init__(self,
        ...
        self._focused = False  # New focus property
    ...
    def _rerender(self):
        ...
        if self._cursor_visible and self._focused:  # Only show cursor when focused
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # Use the new blit_on method to blit and update rect position
        screen.blit(textinput.surface, (10, 10))
        # textinput_custom.blit_on(screen, (10, 50))
